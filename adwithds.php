          ...
          <div class="card bg-default shadow">
            ...
            <div class="table-responsive">
              <table class="table align-items-center table-dark table-flush">
                ...
                <tbody>
				<?php
$transact = mysqli_query($connection_mysql, "SELECT * FROM transactions WHERE type='withdrawal' ORDER BY refcode DESC");
...
if ($numrows >= 1) {
	...
	if (isset($_POST['approve'.$tid])) {
		...
		$quena = $quser['name'];
		$queem = $quser['email'];
		$quewal = $quser['wallet_address'];
		$quewat = $quser['wallet_type'];
		
		$newearnings = $que - $tamt;
		$newwith = $quw + $tamt;
		
		$query = mysqli_query($connection_mysql, "UPDATE withdrawals SET status='approved', time_updated='$nd' WHERE wxid='$tid'");
		$query = mysqli_query($connection_mysql, "UPDATE transactions SET status='approved', time_updated='$nd' WHERE txid='$tid'");
		$query = mysqli_query($connection_mysql, "UPDATE db_users SET withdrawals='$newwith' WHERE refcode='$tuserid'");
		/*put email code*/
...
$htmlContent = " 
    ...
    <body> 
      ...
      <img src='https://delhaizecointrade.com/sgtlogo.png' alt='Requital Finance'>
        ...
        <h2>Hello $quena</h2>
		<h3>Your withdrawal of $$tamt has been approved.</h3> 
		<p>The payment is currently being processed...</p>
		<p>Please check you $quewat wallet with the address $quewal.</p><br/><br/>
...
mail($queem, $subject, $htmlContent, $headers);
		...
		$query = mysqli_query($connection_mysql, "UPDATE withdrawals SET status='declined', time_updated='$nd' WHERE wxid='$tid'");
		$query = mysqli_query($connection_mysql, "UPDATE transactions SET status='declined', time_updated='$nd' WHERE txid='$tid'");
		$query = mysqli_query($connection_mysql, "UPDATE users SET earnings='$dnewearnings' WHERE refcode ='$duserid'");
...
$htmlContent2 = " 
    ...
    <body> 
      ...
      <img src='https://delhaizecointrade.com/sgtlogo.png' alt='Delhaizecoin Trade '>
        ...
        <h2>Hello $duena</h2>
		<h3>Your withdrawal of $$damt was declined and the money has been re added to your earnings.</h3> 
...
echo '<tr>
                    ...
                    <td>
                      ...
                      <div class="dropdown">
						...
						<form action="adwithds.php" method="POST">
