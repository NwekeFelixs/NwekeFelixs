          ...
          <div class="card bg-default shadow">
            ...
            <div class="table-responsive">
              <table class="table align-items-center table-dark table-flush">
                ...
                <tbody>
<?php
$transact = mysqli_query($connection_mysql, "SELECT * FROM transactions WHERE type='deposit' ORDER BY refcode DESC");
...
if ($numrows >= 1) {
	...
	if (isset($_POST['approve'.$tid])) {
		...
		$upliner = $quser['upliner_id'];

		$uplinep = mysqli_query($connection_mysql, "SELECT * FROM db_users WHERE refcode = '$upliner'");
		$upline_info = mysqli_fetch_assoc($uplinep);
		...
		$query = mysqli_query($connection_mysql, "UPDATE deposits SET status='approved', time_updated='$nd' WHERE dxid='$tid'");
		$query = mysqli_query($connection_mysql, "UPDATE transactions SET status='approved', time_updated='$nd' WHERE txid='$tid'");
		$query = mysqli_query($connection_mysql, "UPDATE db_users SET balance='$newbal' WHERE refcode='$tuserid'");
		$query = mysqli_query($connection_mysql, "UPDATE db_users SET balance='$upbal', ref_bonus='$upref' WHERE refcode='$upliner'");
		$query = mysqli_query($connection_mysql, "INSERT INTO referral_bonuses VALUES('', '$upliner', '$user_id', '$user_email', '$refamt', '$nd', '$tid')");
		/*put email code*/
		
$from = 'contact@delhaizecointrade.com'; 
$fromName = 'Delhaizecoin Trade'; 
...
$htmlContent = " 
    ...
    <body> 
      ...
      <img src='https://delhaizecointrade.com/sgtlogo.png' alt='Delhaizecoin Trade'>
        ...
        <h2>Hello $quena</h2>
		<h3>Your deposit of $$tamt has been confirmed.</h3> 
		<p>Log in to your dashboard to invest and start earning.</p>
...
// Send email 
mail($queem, $subject, $htmlContent, $headers);

$from3 = 'contact@delhaizecointrade.com'; 
$fromName3 = 'Delhaizecoin Trade'; 
 
$subject3 = "Referral Bonus"; 
...
$htmlContent3 = " 
    ...
    <body> 
      ...
      <img src='https://delhaizecointrade.com/sgtlogo.png' alt='Delhaizecoin'>
        ...
        <h2>Hello $upline_name</h2>
		<h3>You have earned $$refamt, your 10% referral bonus from $quena</h3> 
...
// Additional headers 
$headers2 .= 'From: '.$fromName3.'<'.$from3.'>' . "\r\n"; 

 
// Send email 
mail($upline_email, $subject3, $htmlContent3, $headers3);
		
		header ("location: addepos.php");
	}
	
		if (isset($_POST['decline'.$tid])) {
		
		$duser = mysql_query("SELECT * FROM transactions WHERE txid='$tid'");
		$dtuser = mysql_fetch_assoc($duser);
		$duserid = $dtuser['user_id'];
		$damt = $dtuser['amount'];
		
		$duserr = mysql_query("SELECT * FROM users WHERE id='$duserid'");
		$duser = mysql_fetch_assoc($duserr);
		$dub = $duser['balance'];
		...
		$query = mysql_query("UPDATE deposits SET status='declined', time_updated='$nd' WHERE dxid='$tid'");
		$query = mysql_query("UPDATE transactions SET status='declined', time_updated='$nd' WHERE txid='$tid'");
		/*$query = mysql_query("UPDATE users SET earnings='$dnewearnings' WHERE id='$duserid'");*/
		/*put email code your deposit was declined, Please initiate another deposit*/
...
$htmlContent2 = " 
    ...
    <body> 
      ...
      <img src='https://delhaizecointrade.com/sgtlogo.png' alt='Delhaizecoin Trade'>
        ...
        <h2>Hello $duena</h2>
		<h3>Your deposit of $$damt was declined.</h3> 
...
echo '<tr>
                    ...
                    <td>
                      ...
                      <div class="dropdown">
						...
						<form action="addepos.php" method="POST">
                          <input type="submit" name="approve'.$tid.'" value="Approve"/><br/>
